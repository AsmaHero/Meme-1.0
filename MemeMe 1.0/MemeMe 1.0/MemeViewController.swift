...
{
    //all the properties of memed image to be used later
    struct Meme {
        var top: String
        var bottom: String
        var image: UIImage
    ...
    {
        // to clear the default text only
        textField.text = ""
    ...
    @IBAction func pick (_ sender: Any)
    {
     ...
     //MARK: - Delegates
    // to take the image from the picker and put it in place of the image
...
// back  the frame of keyboard to normal situation
 ...
 func save() {
    // Create the meme
        let mememe = Meme(top: TOP.text!, bottom: BOTTOM.text!, image: imagePickerView.image!, memedImage: generateMemedImage())
    }
